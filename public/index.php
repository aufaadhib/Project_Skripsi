...
<head>
    ...
    <!-- <link rel="stylesheet" href="./css/output.css" type="text/css" media="screen" title="no title" charset="utf-8" /> -->
</head>
...
<body class>
    <div class="lg:flex">
                ...
                <div class="mt-12">
                    <form action="function/login_process.php" method="POST">
                        <div>
                            ...
                            <input id="email" name="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Enter your username">
                        </div>
                        ...
                        <div class="mt-8">
                            ...
                            <input type="password" id="password" name="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your password">
                        </div>
                        <div class="mt-10">
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Don't have an account ? <button data-modal-target="default-modal" data-modal-toggle="default-modal" type="button"><a class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign
                                up</a></button>
                    </div>
                        ...
                        <div class="relative p-4 w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5">
                                    <form class="space-y-4" action="function/register.php" method="POST">
                                    <div>
                                    ...
                                    <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registration Your Account</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <div class="lg:flex items-center justify-center bg-indigo-100 flex-1 h-screen">
